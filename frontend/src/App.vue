<template>
    ...
    <Tabs default-value="tab-characterView" class="tab" :class="{ 'editViewGrid': editViewGrid }" v-if="characterData.character">
        <div class="tabWrapper">
            ...
            <div class="settings" :class="{ 'active': editViewGrid }" @click="editViewGrid = !editViewGrid">
...
watch(characterData, (newValue, oldValue) => {
    console.log('loaded', oldValue.character, newValue.character);
    saveData(filename);
